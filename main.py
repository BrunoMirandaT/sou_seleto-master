...
def new_cad():
    if request.method == 'POST':
        cursor = db.cursor()
        add = 'insert into cadastros (nomeCadastro, cpfCadastro, nascimentoCadastro, nomeResponsavel, cpfResponsavel, rgResponsavel, nomeMae, nomePai, dataEntrada, tipoSanguineo, celularResponsavel, telefoneResponsavel) values (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)'
...
def update_cad(cad):
    if request.method == 'POST':
        cursor = db.cursor()
        add = 'update cadastros set nomeCadastro = %s, cpfCadastro = %s, nascimentoCadastro = %s, nomeMae = %s, nomePai = %s, nomeResponsavel = %s, cpfResponsavel = %s, rgResponsavel = %s, tipoSanguineo = %s, telefoneResponsavel = %s, celularResponsavel = %s where idCadastro = %s'
